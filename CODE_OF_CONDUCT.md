...
discussions, and commit messages — and also applies when an individual is officially
representing the community in public spaces. Examples of representing our community include
using an official email address, posting via an official social media account, or acting as
an appointed representative at an online or offline event.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the
community leaders responsible for enforcement at **conduct@example.invalid**.

<!-- MAINTAINER: replace conduct@example.invalid above with the address you want published,
     then delete this comment. Until it is a real address, this section is unenforceable. -->
...
Translations, including 简体中文, are available at
