...
Cada uno de esos archivos aparece además nombrado individualmente en
`phase1/scan-coverage.json` con `reason: "unparsable"`, y se queda fuera de los
`scannedFiles` del grafo — de modo que son un hueco _visible_ en lugar de uno silencioso.
