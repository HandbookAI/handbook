...
description: 'Handbook जो भी variable पढ़ता है, उन्हें बनाने वाला नामकरण नियम, .env cascade, और वे जिन्हें कभी config फ़ाइल में नहीं जाना चाहिए।'
---
...
छह settings वे नाम भी स्वीकार करती हैं जो लोगों ने पहले से export कर रखे हैं:
...
`llmApiKey` / `OPENAI_API_KEY` registry में `secret` चिह्नित है, जिसका मतलब है:
