...
理解 Handbooks 在做什么，最快的方式就是看它做一遍。这一步会对一个内置示例项目、用内置的 mock LLM 服务器跑完**整条**流水线——分析、生成、渲染、打包、校验。
...
<div className="not-prose">
  <img
    ...
    alt="Handbooks 流水线：analyze、generate、render、skill、plan、apply、resync"
