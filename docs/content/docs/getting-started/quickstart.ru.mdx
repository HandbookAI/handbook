...
Самый быстрый способ понять, что делает Handbooks, — посмотреть, как он это делает. Здесь
...
<div className="not-prose">
  <img
    ...
    alt="Конвейер Handbooks: analyze, generate, render, skill, plan, apply, resync"
