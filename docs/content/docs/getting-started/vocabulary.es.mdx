...
Handbook usa un puñado de palabras corrientes en sentidos específicos. Tenerlas claras
...
| `skill`    | Handbook renderizado → paquete SKILL de agente                           |  ❌   |
