...
The fastest way to understand what Handbooks does is to watch it do it. This runs the
...
<div className="not-prose">
  <img
    ...
    alt="The Handbooks pipeline: analyze, generate, render, skill, plan, apply, resync"
