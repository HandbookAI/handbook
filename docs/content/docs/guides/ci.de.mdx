...
description: 'Welche Befehle günstig genug sind, um bei jedem Commit zu laufen, welche einen Schlüssel brauchen, und wie ein Build bei Handbook-Drift fehlschlägt.'
---
...
- **Einen PR öffnen statt zu pushen.** Ein regeneriertes Handbook ist ein Diff, den es
  sich zu lesen lohnt.
...
im veröffentlichten Handbook auf exakt den Code, aus dem es gerendert wurde.
...
Behandeln Sie `2` als Planungssignal statt als Build-Bruch. Ein veraltetes Handbook ist
