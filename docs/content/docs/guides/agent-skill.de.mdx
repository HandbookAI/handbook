...
| `--agent-dir`         | Liefert die Locator-Seiten mit und ergänzt das Routing-Protokoll um einen Disambiguierungsschritt |
...
5. _(mit `--agent-dir`)_ Disambiguieren Sie, wenn ein Begriff mehrdeutig ist.
...
- **Locator-Seiten werden als Paar ausgeliefert oder gar nicht.** `SKILL.md` darf niemals
  zu einer Datei routen, die nicht da ist.
