...
description: 'Ein gerendertes Handbook in ein SKILL-Paket mit Drift-Erkennung verwandeln und in einen Coding-Agenten einbinden.'
---
...
Wenn eine Behauptung des Handbooks der echten Quelle widerspricht, hängt der Agent eine
