...
Não é um erro do Handbook, de forma alguma. O Node >= 20.6 tem a sua própria flag
`--env-file` e pré-varre a linha de comando inteira procurando por ela, então morre com um
caminho inexistente **antes** de o Handbook começar. Use a variável no lugar, que nada
