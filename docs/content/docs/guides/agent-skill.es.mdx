...
| `--agent-dir`         | Incluye las páginas localizadoras y añade un paso de desambiguación al protocolo de enrutamiento |
...
5. _(con `--agent-dir`)_ Desambigua cuando un término sea ambiguo.
...
- **Las páginas localizadoras se incluyen en pareja o no se incluyen.** `SKILL.md` nunca
  debe enrutar hacia un archivo que no existe.
